...
- Data was cleaned and transformed using Excel Power Query with the following steps:
   - Removed blank and invalid records (missing Order ID, Sales)
   - Handled duplicates carefully using Order ID + Product ID
   - Standardized text fields (Category, Ship Mode, Segment)
...
- Loaded cleaned data into the Excel Data Model for advanced analysis
